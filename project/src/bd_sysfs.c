...
static ssize_t reads_show(struct device *dev, struct device_attribute *attr,
                          char *buf) {
...
static ssize_t writes_show(struct device *dev, struct device_attribute *attr,
                           char *buf) {
  struct block_dev *bd = dev_to_bd(dev);
...
static ssize_t read_sectors_show(struct device *dev,
...
static ssize_t written_sectors_show(struct device *dev,
                                    struct device_attribute *attr, char *buf) {
  struct block_dev *bd = dev_to_bd(dev);
...
static ssize_t multi_segment_bios_show(struct device *dev,
...
static ssize_t small_requests_show(struct device *dev,
                                   struct device_attribute *attr, char *buf) {
  struct block_dev *bd = dev_to_bd(dev);
...
static ssize_t uptime_ms_show(struct device *dev, struct device_attribute *attr,
                              char *buf) {
  struct block_dev *bd = dev_to_bd(dev);
...
const struct attribute_group *bd_dev_groups[] = {&bd_stat_group, NULL};
